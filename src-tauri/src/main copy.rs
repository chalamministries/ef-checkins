                                                ...
                                                let notification = NotificationData {
                                                    ...
                                                    message: {
                                                        ...
                                                        let status_message = match message["status"].as_i64().unwrap_or(1) {
                                                            0 => "NO MEMBERSHIP",
                                                            2 => "EXPIRED",
                                                            3 => message["message"].as_str().unwrap_or(""),
                                                            1 => message["membership"].as_str().unwrap_or(""),  // Show actual membership for status 1
                                                            _ => message["membership"].as_str().unwrap_or("")
                                                        };
                                                        if status_message != "" {
                                                            message_parts.push(status_message.to_string());
                                                        }
